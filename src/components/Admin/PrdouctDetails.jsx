...
const ProductDetails = () => {
    ...
    useEffect(() => {
        const fetchProductDetails = async () => {
            try {
                const response = await axios.get(`http://localhost:5659/products/${id}`);
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto bg-white mt-10">
            ...
            <div className="flex justify-end">
                <Link to={`/dashboard/products/edit/${product.id}`} className="flex py-2 px-5 bg-green-500 w-fit text-white mb-3 rounded cursor-pointer">Edit <MdOutlineModeEdit className="mt-1 ml-1.5" /></Link>
            </div>
